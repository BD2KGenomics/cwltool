...
setup(name='cwltool-UCSC-CGP',
      ...
      author='Common workflow language working group and UCSC',
      author_email='jshands@ucsc.edu',
      url="https://github.com/common-workflow-language/cwltool",
      download_url="https://github.com/BD2KGenomics/cwltool-docker-host-docker",
      license='Apache 2.0',
